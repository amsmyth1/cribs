...
class RoomTest < Minitest::Test
  ...
  def test_rooms_categories
    ...
    assert_equal [:bedroom, :living_room, :basement], house.rooms_categories
  end
  def test_rooms_by_category
    ...
    expect = {:bedroom => [room_1, room_2], :living_room => [room_3], :basement => [room_4] }


    assert_equal expect, house.rooms_by_category
    assert_equal expect, house.rooms_by_category
  end
end
